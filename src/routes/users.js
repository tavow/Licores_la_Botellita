...
router.post('/register',  uploadAvatar.single('img'), validationsRegister,  usersController.processRegister);

router.get('/edit/:id', authMiddleware, usersController.edit);
router.post('/edit',  uploadAvatar.single('img'), /*validationsRegister,*/ usersController.processEdit);
